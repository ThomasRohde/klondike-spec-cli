...
def serve(
    ...
    async def api_feature_start(feature_id: str):
        ...
        try:
            ...
            # Update progress
            try:
                from .commands.features import regenerate_progress_md, update_quick_reference
    ...
    async def api_feature_verify(feature_id: str, verify_data: dict):
        ...
        from .data import load_config, load_features, load_progress, save_features, save_progress
        from .models import FeatureStatus
